...
class RAMFxmlChanger internal constructor(fxModul: FxModul,
    ...
    override fun changeFxml(o: Observable, msg: String) = when (msg) {
        UpdateCodes.RAM.startGame                      -> changeScene(RamGame_controller.fxml, o)
        UpdateCodes.RAM.mainMenu, UpdateCodes.RAM.quit -> changeScene(RAM_MainMenu_controller.fxml, o)
        MenuCodes.exitToMainGUI                        -> changeScene("common/gui/P3_Gui.fxml", o)
        UpdateCodes.RAM.p1Win                          -> changeScene(RAM_winScreen_controller.fxmlP1Win, o)
        UpdateCodes.RAM.p2Win                          -> changeScene(RAM_winScreen_controller.fxmlP2Win, o)
        UpdateCodes.RAM.tie                            -> changeScene(RAM_winScreen_controller.fxmlTie, o)
        else                                           -> {
