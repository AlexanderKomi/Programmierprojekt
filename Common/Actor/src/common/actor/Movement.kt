...
class Movement {
     ...
     */
    private infix fun isHoldDown(keyName: KeyCode): Boolean {
     ...
     */
    infix fun onKeyPressed(keyName: KeyCode) {
     ...
     */
    infix fun onKeyReleased(keyName: KeyCode) = setKeyHoldDownIfPresent(keyName, false)
}
